...
def test_tuning_hyperparams():
    ...
    param_RF = [{'name': 'min_samples_leaf', 'type': 'Integer', 'low': 50, 'high': 75}, 
    ...
    return tuning_hyperparams(df=df_iris, target='target', parameters=param_RF, algorithm=RandomForestClassifier, metric=None, scoring_option='maximize', n_trials=10)
